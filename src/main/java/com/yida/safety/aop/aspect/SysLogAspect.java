package com.yida.safety.aop.aspect;
...
import com.yida.safety.util.HttpContextUtils;
import com.yida.safety.util.IPUtils;
...
public class SysLogAspect {
     ...
     * 只要出现 @MyLog注解都会进入
     */
    @Pointcut("@annotation(com.yida.safety.aop.annotation.MyLog)")
