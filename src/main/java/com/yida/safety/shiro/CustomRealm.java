...
public class CustomRealm extends AuthorizingRealm {
    ...
    public boolean supports(AuthenticationToken token) {
        return token instanceof com.yida.safety.shiro.CustomUsernamePasswordToken;
    }
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        com.yida.safety.shiro.CustomUsernamePasswordToken customUsernamePasswordToken= (com.yida.safety.shiro.CustomUsernamePasswordToken) authenticationToken;
        SimpleAuthenticationInfo info=new SimpleAuthenticationInfo(customUsernamePasswordToken.getPrincipal(),customUsernamePasswordToken.getCredentials(), com.yida.safety.shiro.CustomRealm.class.getName());
        return info;
    }
}
